...
// Brand glyphs are single-path Simple Icons marks on a 24x24 grid, drawn in
// currentColor so the surrounding link controls the tint and hover state.
function baseProps(props: SocialIconProps) {
  return {
    viewBox: "0 0 24 24",
    fill: "currentColor",
...
export const socialIcons: Record<
  ExternalLinkChannel,
  (props: SocialIconProps) => React.ReactElement
> = {
  x: XIcon,
  ...
  youtube: YouTubeIcon,
  website: XIcon, // unused for Cortex social row; satisfies the channel union
};
